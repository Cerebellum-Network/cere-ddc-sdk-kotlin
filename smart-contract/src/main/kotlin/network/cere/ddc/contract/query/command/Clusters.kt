...
interface Clusters {
    ...
    suspend fun clusterCreate(value: Balance, manager: AccountId, vnodeCount: Long, nodeIds: List<Long>, clusterParams: String, predictGasLimit: Boolean = false): ClusterCreatedEvent
    suspend fun clusterReserveResource(clusterId: Long, amount: Long, predictGasLimit: Boolean = false)
    suspend fun clusterReplaceNode(clusterId: Long, vnodeId: Long, newNodeId: Long, predictGasLimit: Boolean = false): ClusterNodeReplacedEvent
